                                ...
                                <div className="p-6 border-b border-white/5 flex items-center justify-between">
                                    <div className="flex items-center gap-4 flex-1">
                                        <input 
                                            ...
                                            className="bg-transparent text-xl font-bold outline-none flex-1 placeholder:text-gray-600"
                                        />
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <button 
                                            ...
                                            disabled={isSaving}
                                            className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 rounded-xl font-bold text-sm transition-all"
                                        >
